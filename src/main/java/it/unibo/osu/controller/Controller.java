...
public class Controller {
	 ...
	 * @param stage is the stage where the {@link Scene} is loaded when a song is
	 *              selected
	 */
	public Controller(final String name, final Stage stage) {
		...
		this.musicController = MusicControllerImplFactory
				.getMusicImpl("/tracks/" + this.game.getBeatMap().getSongName().stripLeading(), this.game);
